...
test_that("Testing Problem 4 (Part 2)", {
...
test_that("Testing Problem 5 (Part 2)", {
  expect_equal(nrow(baseball), 726)
})

test_that("Testing Problem 8 (Part 2)", {
